...
import { FiltroAssuntoPaceUseCase } from '../FiltroAssuntoPaceUseCase'; // Corrigido para subir um nível
import { ILoginDTO } from '../../../DTO/LoginDTO'; // Suba um nível para acessar DTO
